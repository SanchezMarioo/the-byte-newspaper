      ...
      <div className="border-b border-black dark:border-white">
        {noticias.map((article) => (
          <div
            ...
            className="flex flex-col lg:flex-row border-t border-black dark:border-white cursor-pointer hover:bg-yellow-100 dark:hover:bg-gray-800 transition-colors"
          >
